...
from IntegrityTest import runIntTestCases
...
while operating == True:
    ...
    if input == '1' :
        ...
        # Test the integrity of all the servers
        runIntTestCases((servers[0], 7790))
        # Test the performance of all the servers
        runPerTestCases((servers[0], 7790))
    elif input == '3':
        operating = False;
