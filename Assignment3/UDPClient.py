...
while operating == True:
    ...
    if input == '1' :
        ...
        for i in range(len(servers_representative)):
            runTestCases((servers_representative[i], 7790),fo)
        fo.close()
    elif input == '3':
        operating = False;
