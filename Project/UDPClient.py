...
servers_representative = [["planetlab1.cs.ubc.ca","plonk.cs.uwaterloo.ca","cs-planetlab3.cs.surrey.sfu.ca"],['vn4.cse.wustl.edu','planetlab-01.vt.nodes.planet-lab.org','planetlab1.fit.vutbr.cz'],['planetlabone.ccs.neu.edu','planetlab1.cs.otago.ac.nz','planetlab5.ie.cuhk.edu.hk'],['ricepl-1.cs.rice.edu','ricepl-2.cs.rice.edu','ricepl-4.cs.rice.edu']]
...
while operating == True:
    ...
    if input == '1' :
        ...
        for i in range(len(servers_representative)):
            runTestCases(servers_representative[i],fo)
        fo.close()
    elif input == '3':
        operating = False;
